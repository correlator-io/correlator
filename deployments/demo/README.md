...
- dbt: Set via `OPENLINEAGE_NAMESPACE` environment variable
- GE: Set via `OPENLINEAGE_NAMESPACE` environment variable (or `openlineage_namespace` constructor arg)
- Airflow: Set via `OPENLINEAGE_NAMESPACE` environment variable (or auto-generated by the provider)
